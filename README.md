...
<table>
  ...
  <tr>
    <td>Build a simple cifar-10 conv net </td>
    <td>Week 4</td>
    <td>Patrick</td>
  </tr>
  <tr>
    <td>Build a generative adversarial network </td>
    <td>Week 4</td>
    <td>Davis</td>
  </tr>
  <tr>
    <td>Modify the cifar-10 conv net so it generates adversarial images</td>
    <td>Week 5</td>
    <td>Patrick</td>
  </tr>
  <tr>
    <td>Determine if the discriminator of a GAN can be used to identify adversarial inputs.</td>
    <td>Week 5</td>
    <td>Davis</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Write the code for one type of multi-task learning network</td>
    <td>Week 6</td>
    <td>Davis</td>
  </tr>
  <tr>
    <td>Write the code for using multiple downsampled versions of an images as input to a classifier. </td>
    <td>Week 7</td>
    <td>Patrick</td>
  </tr>
  <tr>
    <td>Write the code for another type of multi-task learning network</td>
    <td>Week 7</td>
    <td>Davis</td>
  </tr>
  <tr>
    <td>Run experiments to see if downsampling improves a networks robustness</td>
    <td>Week 8</td>
    <td>Patrick</td>
  </tr>
  <tr>
    <td>Run experiments to see if multi-task learning improves a networks robustness</td>
    <td>Week 8</td>
    <td>Davis</td>
  </tr>
  <tr>
    <td>See how well these techniques generalize across datasets and across network architectures.</td>
    <td>Week 9</td>
    <td>Patrick</td>
  </tr>
  <tr>
